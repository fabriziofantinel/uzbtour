...
5. Portare la baseline runtime a zero. Completato con le migrazioni 149 e 150. Le migrazioni 151-158 hanno inoltre convertito Login come agenzia, dashboard, gestione agenti, branding, anagrafica e letture superuser, riducendo a 68 le firme storiche censite dal gate statico. La loro rimozione fisica procede per dominio dopo l'introduzione e la verifica del sostituto nativo.
