...
5. Portare la baseline runtime a zero. Completato con le migrazioni 149 e 150. Le migrazioni 151-153 hanno inoltre convertito Login come agenzia e letture della dashboard, riducendo a 80 le firme storiche censite. La loro rimozione fisica procede per dominio dopo l'introduzione e la verifica del sostituto nativo.
