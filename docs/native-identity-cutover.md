...
5. Portare la baseline runtime a zero. Completato con le migrazioni 149 e 150. Le migrazioni 151-163 hanno inoltre convertito Login come agenzia, dashboard, gestione agenti, branding, anagrafica, letture superuser, ciclo del responsabile, cancellazione agenzia/viaggio, ciclo della bozza importata, dispatch dei workload e creazione viaggio/partenza, riducendo a 54 le firme storiche censite dal gate statico. La loro rimozione fisica procede per dominio dopo l'introduzione e la verifica del sostituto nativo.
