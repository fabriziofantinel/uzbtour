...
const name="057_v3_shared_email_legacy_index_fix",model="3.28.1-shared-email-legacy-index-fix";
...
try{
  ...
  const gate=(await client.query(`SELECT
    ...
    to_regclass('public.platform_users_normalized_email_idx') IS NOT NULL lookup_index_present`)).rows[0];
