...
const name="032_v3_traveler_scope_read_cutover";
const model="3.6.0-traveler-scope-read-cutover";
...
try{
  ...
  await client.query("SELECT pg_advisory_xact_lock(hashtextextended('smf-travel:v3-traveler-scope-read-cutover',0))");
  await client.query(source);
  const gates=(await client.query(`SELECT
    has_function_privilege('smf_app','app.list_legacy_user_journeys(text)','EXECUTE') journeys,
