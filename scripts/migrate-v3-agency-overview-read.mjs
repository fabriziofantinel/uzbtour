...
const name="052_v3_agency_overview_read_cutover",model="3.24.0-agency-overview-read";
...
try{
 ...
 const gates=(await client.query(`SELECT
   ...
   has_function_privilege('smf_app','app.read_travel_companions_v3(text)','EXECUTE') companions`)).rows[0];
 ...
 console.log(JSON.stringify({status:apply?"applied":"dry_run_passed",role:role.role_name,executionMs,gates,
