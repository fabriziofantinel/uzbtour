...
const name = "054_v3_identity_result_contract_fix",
  model = "3.26.0-identity-result-contract-fix";
...
try {
  ...
  const candidate = (
    await client.query(`SELECT users.id,users.normalized_email,identity.subject
    ...
    JSON.stringify(
      {
        ...
        role: role.role_name,
        executionMs,
        gates: { resolvedUser: true, runtimeExecute },
