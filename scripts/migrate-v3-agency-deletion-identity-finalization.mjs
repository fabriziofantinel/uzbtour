...
const name = "059_v3_agency_deletion_identity_finalization",
  model = "3.30.0-agency-deletion-identity-finalization";
...
try {
  ...
  const gate = (
    await client.query(`SELECT has_function_privilege('smf_app',
    'app.finalize_agency_deletion_identities_v3(uuid)','EXECUTE') runtime_finalize`)
  ).rows[0];
