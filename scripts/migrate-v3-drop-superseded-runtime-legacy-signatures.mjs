...
const name = "166_v3_drop_superseded_runtime_legacy_signatures";
...
try {
  ...
  await client.query(
    "SELECT pg_advisory_xact_lock(hashtextextended('smf-travel:v3-drop-superseded-runtime-legacy-signatures',0))",
  );
  ...
  if (gate?.legacy_signatures !== 53 || gate?.executable_legacy_signatures !== 53) {
  ...
  if (apply) {
    await client.query(
      ...
      ["3.111.0-drop-superseded-runtime-legacy-signatures", checksum],
    );
