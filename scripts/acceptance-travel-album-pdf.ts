...
async function main() {
  ...
  const loaded: string[] = [];
  const png = await sharp({ create: { width: 720, height: 480, channels: 3, background: "#22b8c7" } })
    .png()
    .toBuffer();
  const experience = {
    journey: {
      ...
      partyId: "party-alpha",
      agencyName: "Agenzia Demo",
      partyName: "Gruppo Alpha",
    ...
    days: [
      {
        ...
        number: 1,
        date: "2026-09-10",
        title: "Arrivo ad Hanoi",
        city: "Hanoi",
        description: "Accoglienza e prima passeggiata nel quartiere antico.",
      },
      {
        id: "day-2",
        number: 2,
        ...
        title: "La baia",
        city: "Ha Long",
        description: "Navigazione e incontro con il paesaggio della baia.",
      },
    ],
    notes: [
      {
        ...
        dayId: "day-1",
        dayNumber: 1,
        text: "Il primo caffe vietnamita del gruppo.",
        updatedBy: "Capogruppo",
    ...
    photos: [
      {
        ...
        dayId: "day-1",
        dayNumber: 1,
        originalName: "hanoi.png",
        contentType: "image/png",
        sizeBytes: png.length,
        addedBy: "Viaggiatore Alpha",
    ...
    challengeResults: [
      {
        id: "result-1",
        travelerId: "traveler-alpha",
        travelerName: "Viaggiatore Alpha",
        dayId: "day-1",
        contentId: "content-1",
        type: "mission",
        score: 10,
