...
try {
  ...
  const gate = (
    ...
    EXISTS(SELECT 1 FROM information_schema.columns WHERE table_schema='travel' AND table_name='party_memberships' AND column_name='participates_in_trip_games') traveler_scope_ok`)
  ).rows[0];
