...
PASSED = {
    ...
    "UC-GAM-01", "UC-GAM-02", "UC-GAM-03", "UC-GAM-04", "UC-GAM-05", "UC-GAM-06", "UC-GAM-07", "UC-GAM-08",
    "UC-VIS-01", "UC-VIS-02",
...
def evidence(case_id):
    ...
    if case_id in PASSED:
        mapping = {
            ...
            "GAM": "Acceptance runtime con rollback e Bedrock reale: quiz, giochi e contest verificati; scoring AI Nova Lite tipizzato e identificativi foto validati.",
...
def load_command_results():
    ...
    rows.extend([
        ...
        ["acceptance:bingo-scoring", "SUPERATO", "7 scenari", "Calcolo condiviso verificato: ambo 5, terno 10, quaterna 20, cinquina 30 per riga, tombola +50, massimo 140."],
