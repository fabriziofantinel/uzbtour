...
REVOKE ALL ON FUNCTION app.read_agency_staff_v3(UUID,UUID),
  ...
  app.assign_departure_staff_days_v3(UUID,UUID,UUID,TEXT,UUID[]),app.remove_agency_staff_v3(UUID,UUID,TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION app.read_agency_staff_v3(UUID,UUID),
  app.provision_agency_staff_v3(UUID,UUID,TEXT,TEXT,TEXT,TEXT,TEXT,TEXT,TEXT,TIMESTAMPTZ),
  app.assign_departure_staff_days_v3(UUID,UUID,UUID,TEXT,UUID[]),app.remove_agency_staff_v3(UUID,UUID,TEXT) TO smf_app;
