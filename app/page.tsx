...
const days: Day[] = [
  ...
  { n: 3, date: "4 AGO", city: "Khiva → Bukhara", title: "Nel deserto sulla Via della Seta", type: "bus", from: "Khiva", to: "Bukhara", duration: "480 km · 6/7 ore", description: "Partenza in veicolo privato attraverso il deserto del Kyzylkum con soste tecniche. Arrivo nel pomeriggio e passeggiata orientativa nel centro storico.", activities: ["Deserto del Kyzylkum", "Centro storico di Bukhara"], color: "#C4902F", lat: 39.7681, lon: 64.4556, hotel: "Shaxriston, Bukhara", service: "Autista privato · cena inclusa" },
