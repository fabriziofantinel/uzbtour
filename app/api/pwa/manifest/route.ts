...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    shortcuts: [
      { name: "Programma di oggi", short_name: "Oggi", url: "/viaggio?tab=programma&day=oggi", icons: [{ src: "/icons/shortcut-programme.png", sizes: "96x96", type: "image/png" }] },
      { name: "Spese e cassa", short_name: "Spese", url: "/viaggio?tab=spese", icons: [{ src: "/icons/shortcut-expenses.png", sizes: "96x96", type: "image/png" }] },
      { name: "Voucher e documenti", short_name: "Documenti", url: "/viaggio?tab=documenti", icons: [{ src: "/icons/shortcut-documents.png", sizes: "96x96", type: "image/png" }] },
    ],
