...
import { getImportAgency, getOriginalImportDocument } from "@/lib/platform/import-repository";
...
export async function GET(
  ...
  try {
    ...
    const document = await getOriginalImportDocument(id, agencyId);
    ...
    return platformApiError(error, "Download del preventivo originale non riuscito");
  }
}
