...
export const importedActivitySchema = z.object({
  ...
  startsAt: z.string().max(5).describe("Usa sempre una stringa vuota: gli orari non vengono importati"),
  endsAt: z.string().max(5).describe("Usa sempre una stringa vuota: gli orari non vengono importati"),
