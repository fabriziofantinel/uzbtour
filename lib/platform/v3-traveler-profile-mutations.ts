...
export async function updateOwnTripCompetition(input:{userId:string;departureId:string;partyId:string;enabled:boolean}){
...
export async function transferOwnGroupLeadership(input:{userId:string;departureId:string;partyId:string;travelerId:string}){
